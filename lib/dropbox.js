...
_.extend(Dropbox.prototype, {
  ...
  sync_entries: function sync_entries(result) {
    ...
    return Q.all(_.map(folder_or_delete[true], this.sync_folder_or_delete.bind(this))).then(function() {
      return Q.all(_.map(folder_or_delete[false], this.sync_file.bind(this)));
    }.bind(this)).then(function() { return result.cursor; });
  },
